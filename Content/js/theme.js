$(function () {
    ...
    $('.menu-overlay').click(function () {
        ...
        UIkit.toggle('.menu-button').toggle();
    });
});
...
//    var contact = 'Kariyer formunuz tarafımıza ulaşmıştır.';
//    var contactErr = 'Bir hata oluştu';
//    switch (lang) {
//        case 'tr':
//            contact = 'Kariyer formunuz tarafımıza ulaşmıştır.';
//            contactErr = 'Bir hata oluştu';
//            break;
//        case 'en':
...
//        $.ajax({
//            url: "/clockwork/surface/helper/SaveCareerForm",
//            method: "POST",
//            data: {
...
//                'UploadCV': $('input[name="UploadCV"]').val(),
//                'emailHdd': $('input[name="emailHdd"]').val(),
//                'Position': $('input[name="Position"]').val(),
//            },
//            success: function (e) {
//                $('#results').html('<div class="alert alert-success">' + contact + '</div>');
//                $("#contactSubmit").attr('disabled', true);
//            },
//            error: function () {
//                $('#results').html('<div class="alert alert-warning">' + contactErr + '</div>');
